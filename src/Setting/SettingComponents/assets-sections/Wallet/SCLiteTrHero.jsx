...
const coins = [
  ...
  { icon: "🟡", symbol: "BNB", name: "BNB" },
];

const SCLiteTrHero = () => {
  const [selectedCoin, setSelectedCoin] = useState(coins[0]);
  const [amount, setAmount] = useState("0");
  const [available] = useState("0 OG");
      ...
      <div className="w-full max-w-lg">
        <div className="bg-sub-card rounded-3xl p-6 sm:p-8 border border-custom-border shadow-lg">
          ...
          <div className="flex items-center justify-between mb-4">
            <h1 className="text-gradient text-2xl font-bold">Transfer to SC-Lite TR</h1>
          ...
          <p className="text-secondary-desc mb-4">
            Trade with Turkish Lira. Deposit and withdraw instantly with direct bank transfer.
          </p>
          ...
          <div className="mb-6 relative">
            ...
            {open && (
              <div
                className="absolute mt-1 w-full bg-card border border-custom-border rounded-xl shadow-lg overflow-hidden z-20 animate-fadeSlide"
              >
                    ...
                    >
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <div className="text-xs text-secondary-desc">{coin.name}</div>
                        </div>
                      </div>
          ...
          <div className="mb-3">
            ...
            <div className="relative bg-card border border-custom-border rounded-xl px-4 py-4 flex items-center justify-between">
              ...
              />
              <div className="flex items-center gap-3">
                <span className="text-secondary-desc font-medium">OG</span>
                <button className="text-gradient font-bold hover:opacity-80 transition">MAX</button>
              </div>
            </div>
          </div>

          <p className="text-sm text-secondary-desc text-right mb-6">
            24h Withdraw Limit: <span className="font-semibold">0 USDT</span> / 30000 USDT
          </p>
