...
const BuyCryptoTabs = () => {
  ...
  const tabs = ["Buy & Sell", "Recurring Buy", "Deposit", "Withdraw"];

  return (
    <div className="">
      {/* Navigation Bar */}
      <div className="border-b border-custom-border">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between px-4 sm:px-6 py-2 gap-4 sm:gap-0">
          {/* Tab Navigation */}
      ...
      <div className="">
        ...
        {activeTab === "Recurring Buy" && <RecurringBuy />}
